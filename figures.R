...
xxx <- group_fairness_summary[,1,]
group_fairness_summary[,1,] <- group_fairness_summary[,2,]
group_fairness_summary[,2,] <- xxx
group_fairness_summary[,1,] <-group_fairness_summary[,2,]  

xxx <- individual_fairness_summary[,1,]
individual_fairness_summary[,1,] <- individual_fairness_summary[,2,]
individual_fairness_summary[,2,] <- xxx

xxx <- race_fairness_summary[,1,]
race_fairness_summary[,1,] <- race_fairness_summary[,2,]
race_fairness_summary[,2,] <- xxx
